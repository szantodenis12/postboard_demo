...
export interface AnalyticsStore {
  [clientId: string]: ClientAnalytics
}
...
export function writeAnalytics(store: AnalyticsStore) {
...
export async function fetchClientAnalytics(
  ...
  // Combined
  const allPosts = [...fbPosts, ...igPosts].sort(
...
export function writeReports(reports: ReportToken[]) {
